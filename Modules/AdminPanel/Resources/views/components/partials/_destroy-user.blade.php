<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#{{ $identification }}"><i class="fas fa-user-times"></i></button>
<!-- Modal -->
<div class="modal fade" id="{{ $identification }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog p-5" role="document">
        ...
        <div class="modal-header bg-kolombaris text-white">
            <h5 class="modal-title" id="exampleModalLabel"> <i class="fas fa-user-minus"> </i> Warning</h5>
