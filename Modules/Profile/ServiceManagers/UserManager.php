...
namespace Modules\Profile\ServiceManagers;

use RuntimeException;
use Illuminate\Support\Str;
use App\Http\Resources\Form\Form;
use Modules\Profile\Http\Builders\Contract\BuilderContract;
use Illuminate\Contracts\Container\Container as Laravel;

class UserManager extends Form
{
    /** @var Laravel|null */
    protected $laravel;
    ...
    */
     ...
     */
    protected function resolveBuilderClass(string $builders)
    {
        $constructor = (new \ReflectionClass($builders))->getConstructor();
        ...
        return $this->getLaravel()->make($builders, $parameters);
    }
